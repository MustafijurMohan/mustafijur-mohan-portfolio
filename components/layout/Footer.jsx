...
const socialLinks = [
  ...
  {
    name: "Email",
    href: "mailto:mustafijurmohan@gmail.com",
    icon: (
      <svg
        className="w-5 h-5"
        fill="none"
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/mohanmustafijur",
    icon: (
      <svg
        className="w-5 h-5"
        fill="currentColor"
  ...
  {
    name: "Reddit",
    href: "https://www.reddit.com/user/Mustafijur_Dev",
    icon: (
      <svg
        className="w-5 h-5"
        fill="currentColor"
        ...
        aria-hidden="true"
      >
        <path d="M24 11.5c0-1.65-1.35-3-3-3-.96 0-1.86.48-2.42 1.24-1.64-1-3.85-1.64-6.29-1.72l1.3-4.14 4.22.97c.02.68.58 1.23 1.27 1.23 1.69 0 1.69-2.5 0-2.5-.54 0-1 .35-1.18.85l-4.61-1.06c-.18-.04-.37.04-.45.21l-1.54 4.89c-2.51.04-4.8.69-6.49 1.71-.56-.76-1.46-1.24-2.42-1.24-1.65 0-3 1.35-3 3 0 1.31.84 2.41 2.01 2.81-.01.19-.01.39-.01.59 0 3.53 4.09 6.4 9.15 6.4s9.15-2.87 9.15-6.4c0-.2-.01-.4-.02-.59 1.17-.4 2.01-1.5 2.01-2.81zM8.03 13.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5zm7.47 3.5c-1.82 1.82-5.18 1.82-7 0-.15-.15-.15-.39 0-.54.15-.15.39-.15.54 0 1.52 1.52 4.4 1.52 5.92 0 .15-.15.39-.15.54 0 .15.15.15.39 0 .54zm-.47-2c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
      </svg>
    ),
  },
];
